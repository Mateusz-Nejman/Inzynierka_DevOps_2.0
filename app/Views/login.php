                ...
                <div class="content">
                    <div class="flexCenter">
                        <div class="col" id="loginBox">
                            ...
                            <div class="formGroup">
                                <?= formBegin(); ?>
                                <?= formTextBoxTitled("Email", "email", "loginEmail", "", "", "text", false, "loginSubmit"); ?>
                                <?= formPasswordBoxTitled("Hasło", "password", "loginPassword", "", false, "loginSubmit"); ?>
                        ...
                        <div class="col" id="registerBox" style="display: none">
                            ...
                            <div class="formGroup">
                                <?= formBegin(); ?>
                                <?= formTextBoxTitled("Email", "email", "loginNewEmail", "", "", "text", false, "loginNewSubmit"); ?>
                                <?= formPasswordBoxTitled("Hasło", "password", "loginNewPassword", "", false, "loginNewSubmit"); ?>
                                <div style="display: flex; flex-direction: row">
